...
const sty = {
  ...
  dropZone: { border: '2px dashed #ccc', borderRadius: 8, padding: '14px 16px', textAlign: 'center' as const, cursor: 'pointer', background: '#fafafa', transition: 'all 0.2s', outline: 'none' } as React.CSSProperties,
  dropZoneDragOver: { borderColor: '#28a745', background: '#e3fcef' } as React.CSSProperties,
  dropText: { fontSize: 13, color: '#666' } as React.CSSProperties,
  ...
  fieldValue: { color: '#333' } as React.CSSProperties,
