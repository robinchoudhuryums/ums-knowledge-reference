...
const styles: Record<string, React.CSSProperties> = {
  ...
  failureExplain: { fontSize: '11px', color: '#8DA4B8', marginBottom: '12px', fontStyle: 'italic' },
  ...
  failureDate: { fontSize: '11px', color: '#8DA4B8' },
  failureNotes: { marginTop: '6px', fontSize: '12px', color: '#6B8299', fontStyle: 'italic' },
  emptyState: { padding: '24px', textAlign: 'center' as const, color: '#8DA4B8', fontSize: '13px' },
};
