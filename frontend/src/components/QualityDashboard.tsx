...
const styles: Record<string, React.CSSProperties> = {
  ...
  periodActive: { padding: '5px 12px', border: '1px solid #1B6FC9', borderRadius: '6px', background: '#E3F2FD', cursor: 'pointer', fontSize: '12px', color: '#1565C0', fontWeight: 600 },
  ...
  chartBar: { height: '100%', background: 'linear-gradient(90deg, #1B6FC9, #42A5F5)', borderRadius: '4px', display: 'flex', alignItems: 'center', minWidth: '2px' },
